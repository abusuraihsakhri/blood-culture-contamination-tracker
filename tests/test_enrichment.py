"""
Automated Pytest for blood-culture-contamination-tracker Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    DifferentialEngine,
    BloodEngine,
    BloodculturecontaminationtrackerEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = BloodculturecontaminationtrackerEnrichmentSuite()
