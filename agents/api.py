"""
FastAPI REST API Server for Blood Culture Contamination Tracker.
"""
...
app = FastAPI(
    title="Blood Culture Contamination Tracker API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "blood-culture-contamination-tracker", "domain": "Antimicrobial Stewardship & Microbiology", "standard": "CLSI M100 / EUCAST / CDC NHSN Guidelines", "version": "3.0.0-ENTERPRISE"}
