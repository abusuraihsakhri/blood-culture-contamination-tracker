"""
Command Line Interface for Blood Culture Contamination Tracker.
"""
import argparse
import csv
import json
...
def main(argv=None):
    parser = argparse.ArgumentParser(prog="blood-culture-contamination-tracker", description="Blood Culture Contamination Tracker")
    ...
    if args.command == "audit":
        ...
        print("=" * 80)
        print(f"  BLOOD CULTURE CONTAMINATION TRACKER")
    ...
    if args.command == "chat":
        ...
        print(f"\n[Blood Culture Contamination Tracker Supervisor]:\n{ans}\n")
        return 0
    ...
    if args.command == "serve":
        ...
        print(f"Starting Blood Culture Contamination Tracker API server on http://{args.host}:{args.port}")
